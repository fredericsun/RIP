...
public class RouteEntry 
{
    ...
    /** distance from the node to the router */
    private int route_metric;
	...
	public RouteEntry(int destinationAddress, int gatewayAddress, 
			int maskAddress, Iface iface, int route_metric)
	{
		this.destinationAddress = destinationAddress;
		this.gatewayAddress = gatewayAddress;
		this.maskAddress = maskAddress;
		this.iface = iface;
		this.route_metric = route_metric;
	}

    public int getMetric() {
        return this.route_metric;
    }

    public void setMetric(int route_metric) {
	    this.route_metric = route_metric;
    }
	/**
